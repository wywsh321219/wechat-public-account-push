...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx4d1caa80a5cbdf8d',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'cdba6ac0561aab48a74e2a5fd021354e',
  ...
  USERS: [
    {
      ...
      id: 'o6I3a54jJHJA_KfqPcYjNsMzz57o',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'dXOGqdSzv0FKz4N-1m0RI3FLYilb5LsE6plwbWTB_G8',
      // 所在省份
      province: '辽宁',
      // 所在城市
      city: '沈阳',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1998', date: '02-19',
        },
        {
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-08-29' },
        // 结婚纪念日
